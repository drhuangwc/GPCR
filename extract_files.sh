...
echo "-------------------------- FOLDER and subfolders: colorPDB_selefeatureTOP200 --------------------------"
echo "tar -xvf GPCR_to_trainAgonistAntagonist_humanalltrainconcat_selefeatureTOP200.tar.xz"
tar -xvf GPCR_to_trainAgonistAntagonist_humanalltrainconcat_selefeatureTOP200.tar.xz
echo "--------------------------"
echo "tar -xvf OriPDB.tar.xz"
tar -xvf OriPDB.tar.xz

###### FOLDER and subfolders: GPCR_agonist_GPRC5A

echo "-------------------------- FOLDER and subfolders: GPCR_agonist_GPRC5A --------------------------"
...
echo "--------------------------"
echo "tar -xvf AutogluonTRAIN0618_AgonistAntagonist_humanalltrainconcat_selefeatureTOP200_102min.tar.xz"
...
echo "tar -xvf GPCR_to_trainAgonistAntagonist_all.tar.xz"
...
echo "tar -xvf padleout_molecule_1d2ddescriptor09190015_GPCR_AgonistAntagonist_protein_align_ptcode123_20220915.tar.xz"
...
echo "-------------------------- FOLDER and subfolders: Human_AgonistAntagonist/GPCR_similarty --------------------------"
cd GPCR_similarty
echo "tar -xvf GPCR_to_trainAgonistAntagonist_humanalltrainconcat_selefeatureTOP200.tar.xz"
tar -xvf GPCR_to_trainAgonistAntagonist_humanalltrainconcat_selefeatureTOP200.tar.xz
echo "--------------------------"
echo "tar -xvf similarty_proteinpairsimilarity20230624_TOP200_proteinseq20220915_align_7CUT.tar.xz"
